@echo off
chcp 65001 >nul
title Core 4 pick 100% load - 2 hour limit

rem PERSONAL launcher - core 4 ONLY, steady 100% single-core load,
rem auto-stops after 2 hours. Tests sustained high-boost Vmin on core 4.
...
echo ============================================================
echo  CORE 4  pick 100%% load  -  auto-stop after 2 hours
echo  Steady high-boost single-core soak on core 4 only.
...
"%EXE%" --single --core 4 --minutes 120 --seconds 120 --cycles 0
