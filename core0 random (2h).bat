@echo off
chcp 65001 >nul
title Core 0 transient RANDOM - 2 hour limit

rem PERSONAL launcher - core 0 ONLY, real-world RANDOM transient
...
echo ============================================================
echo  CORE 0  transient RANDOM (real-world)  -  stop after 2h
echo  Utilisation wanders 0-^>100%% like real use on core 0 only.
...
"%EXE%" --transient --random --core 0 --minutes 120 --seconds 120 --cycles 0
