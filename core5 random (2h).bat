@echo off
chcp 65001 >nul
title Core 5 transient RANDOM - 2 hour limit

rem PERSONAL launcher - core 5 ONLY, real-world RANDOM transient
...
echo ============================================================
echo  CORE 5  transient RANDOM (real-world)  -  stop after 2h
echo  Utilisation wanders 0-^>100%% like real use on core 5 only.
...
"%EXE%" --transient --random --core 5 --minutes 120 --seconds 120 --cycles 0
