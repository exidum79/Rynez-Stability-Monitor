@echo off
chcp 65001 >nul
title Core 5 pick 100% load - 2 hour limit

rem PERSONAL launcher - core 5 ONLY, steady 100% single-core load,
rem auto-stops after 2 hours. Tests sustained high-boost Vmin on core 5.
...
echo ============================================================
echo  CORE 5  pick 100%% load  -  auto-stop after 2 hours
echo  Steady high-boost single-core soak on core 5 only.
...
"%EXE%" --single --core 5 --minutes 120 --seconds 120 --cycles 0
