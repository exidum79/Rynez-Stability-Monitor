@echo off
chcp 65001 >nul
title Core 3 transient RANDOM - 2 hour limit

rem PERSONAL launcher - core 3 ONLY, real-world RANDOM transient
...
echo ============================================================
echo  CORE 3  transient RANDOM (real-world)  -  stop after 2h
echo  Utilisation wanders 0-^>100%% like real use on core 3 only.
...
"%EXE%" --transient --random --core 3 --minutes 120 --seconds 120 --cycles 0
